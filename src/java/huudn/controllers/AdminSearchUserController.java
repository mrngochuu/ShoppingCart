...
public class AdminSearchUserController extends HttpServlet {
    ...
    private static final String SUCCESS = "manageUser.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (txtSearch != null) {
                ...
                List<UserDTO> listUserDTOs = userDAO.searchUserByUsername(txtSearch);
                if(!listUserDTOs.isEmpty()) {
                    RoleDAO roleDAO = new RoleDAO();
                    List<RoleDTO> listRoleDTOs = roleDAO.getListRole();
                    request.setAttribute("LIST_ROLE", listRoleDTOs);
                } 
                request.setAttribute("LIST_USER", listUserDTOs);
            }
        } catch (Exception e) {
