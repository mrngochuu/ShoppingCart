 ...
 * @author ngochuu
 */
public class AdminShowOrderDetailsController extends HttpServlet {

    private static final String SUCCESS = "manageHistoryUserDetails.jsp";
    private static final String FAILED = "AdminShowInfoUserController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("ERROR at AdminShowOrderDetailsController: " + e.getMessage());
        } finally {
