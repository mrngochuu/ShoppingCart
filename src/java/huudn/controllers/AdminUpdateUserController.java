...
public class AdminUpdateUserController extends HttpServlet {
    ...
    private static final String SUCCESS = "AdminSearchUserController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String active = request.getParameter("cbState");
            ...
            if(!userDAO.updateByAdmin(userDTO)) {
                request.setAttribute("MESSAGE", "Update failed!");
            }
        } catch (Exception e) {
            log("ERROR at AdminUpdateUserController: " + e.getMessage());
        } finally {
